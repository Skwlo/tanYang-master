    ...
    <div class="livestock-header">
      <div class="livestock-header-main">
        <div class="livestock-header-title-bg">
          <h2>🐮 绿色牧场 · 淘汰记录信息管理</h2>
          <div class="livestock-header-desc">管理所有淘汰记录的基础信息与操作</div>
        </div>
      </div>
    </div>
    <!-- 卡片包裹表格 -->
      ...
      <BasicTable @register="registerTable" :rowSelection="rowSelection">
        <template #tableTitle>
          <div class="livestock-btn-group">
            ...
            <a-button type="primary" style="background: #66bb6a; border: none" v-auth="'eliminationRecord:elimination_record:exportXls'" preIcon="ant-design:export-outlined" @click="onExportXls"> 导出</a-button>
            <j-upload-button type="primary" style="background: #81c784; border: none" v-auth="'eliminationRecord:elimination_record:importExcel'" preIcon="ant-design:import-outlined" @click="onImportXls">导入</j-upload-button>
            <a-dropdown v-if="selectedRowKeys.length > 0">
              ...
              <a-button v-auth="'eliminationRecord:elimination_record:deleteBatch'" style="background: #a5d6a7; border: none">
                批量操作
