<template>
  <div class="livestock-bg">
    ...
    <div class="livestock-header">
      <div class="livestock-header-main">
        <div class="livestock-header-title-bg">
          <h2>🐮 绿色牧场 ·配方原料信息管理</h2>
          <div class="livestock-header-desc">管理所有配方原料的基础信息、状态与操作</div>
        </div>
      </div>
    </div>
    <!-- 卡片包裹表格 -->
    <a-card class="livestock-table-card">
      <BasicTable @register="registerTable" :rowSelection="rowSelection">
        <template #tableTitle>
          <div class="livestock-btn-group">
            <a-button type="primary" v-auth="'formulaIngredient:formula_ingredient:add'" @click="handleAdd" preIcon="ant-design:plus-outlined">
              新增
            </a-button>
            <a-button
              type="primary"
              style="background: #66bb6a; border: none"
              v-auth="'formulaIngredient:formula_ingredient:exportXls'"
            ...
            <j-upload-button
              ...
              v-auth="'formulaIngredient:formula_ingredient:importExcel'"
            ...
            <a-dropdown v-if="selectedRowKeys.length > 0">
              ...
              <a-button v-auth="'formulaIngredient:formula_ingredient:deleteBatch'" style="background: #a5d6a7; border: none">
                批量操作
      ...
      <FormulaIngredientModal @register="registerModal" @success="handleSuccess" />
    </a-card>
  </div>
</template>
