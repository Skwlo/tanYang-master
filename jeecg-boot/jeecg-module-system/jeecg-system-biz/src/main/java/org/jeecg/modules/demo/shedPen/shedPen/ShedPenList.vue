   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
     <!--插槽:table标题-->
      <template #tableTitle>
          ...
          <a-button  type="primary" v-auth="'shedPen:shed_pen:exportXls'" preIcon="ant-design:export-outlined" @click="onExportXls"> 导出</a-button>
          <j-upload-button type="primary" v-auth="'shedPen:shed_pen:importExcel'" preIcon="ant-design:import-outlined" @click="onImportXls">导入</j-upload-button>
          <a-dropdown v-if="selectedRowKeys.length > 0">
              ...
              <a-button v-auth="'shedPen:shed_pen:deleteBatch'">批量操作
    ...
    <!-- 表单区域 -->
    <ShedPenModal @register="registerModal" @success="handleSuccess"></ShedPenModal>
  </div>
</template>
