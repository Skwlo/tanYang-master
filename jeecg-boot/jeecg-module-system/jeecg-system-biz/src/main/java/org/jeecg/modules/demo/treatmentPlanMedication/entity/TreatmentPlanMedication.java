package org.jeecg.modules.demo.treatmentPlanMedication.entity;
...
@Schema(description="治疗方案用药明细表")
public class TreatmentPlanMedication implements Serializable {
